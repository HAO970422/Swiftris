...
SWIFT_CLASS("_TtC8Swiftris11AppDelegate")
...
SWIFT_CLASS("_TtC8Swiftris9GameScene")
...
@property (nonatomic) NSTimeInterval tickLengthMills;
...
- (void)playSoundWithSound:(NSString * _Nonnull)sound;
- (void)update:(CFTimeInterval)currentTime;
- (void)startTicking;
- (void)stopTicking;
- (CGPoint)pointForColumnWithColumn:(NSInteger)column row:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified linesLabel;
- (IBAction)didTap:(UITapGestureRecognizer * _Nonnull)sender;
- (IBAction)didPanWithSender:(UIPanGestureRecognizer * _Nonnull)sender;
- (IBAction)UpButtonPressed:(id _Nonnull)sender;
- (IBAction)DownButtonPressed:(id _Nonnull)sender;
- (IBAction)LeftButtonPressed:(id _Nonnull)sender;
- (IBAction)RightButtonPressed:(id _Nonnull)sender;
- (IBAction)didSwipeWithSender:(UISwipeGestureRecognizer * _Nonnull)sender;
